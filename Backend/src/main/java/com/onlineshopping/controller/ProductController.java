...
//		
//		//Searching Product by Name(here i use in place of name of the product as Title)
...
//public List<Product> getProductsByTitleArr(String title) {
//		
//	
//	String[] arr=title.split(" ");
//		//Searching Product by Name(here i use in place of name of the product as Title)
//		List<Product>	products = productDao.findByTitleString(arr);
//		
//		return products;
//		
//	}
